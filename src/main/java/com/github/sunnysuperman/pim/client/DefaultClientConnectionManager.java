...
import com.github.sunnysuperman.pim.protocol.CommunicationPacketTypes;
import com.github.sunnysuperman.pim.protocol.DisconnectPacket;
...
public class DefaultClientConnectionManager implements ClientConnectionManager {
    ...
    protected final PacketWriter clientPacketWriter;
    ...
    public DefaultClientConnectionManager(String myServerId, boolean resourceEnabled, RouteTable routeTable,
            PacketWriter clientPacketWriter, ClusterPacketRouter clusterPacketRouter,
            RegionPacketRouter regionPacketRouter, boolean multiRegionLoginNotificationEnabled) {
        super();
        this.myServerId = Utils.notNull(myServerId);
        ...
        this.myRouteResult = resourceEnabled ? null
                : new RouteResult(regionPacketRouter != null ? regionPacketRouter.getMyRegionId() : null, myServerId,
                        null);
    }
    ...
    private void removeLocalhostDuplicateConnection(String clientKey, ChannelHandlerContext connection) {
        try {
            ...
            clientPacketWriter.write(DISCONNECT_PACKET, connection.channel(), -1);
            connection.close();
        } catch (Throwable t) {
            LOG.error(null, t);
        }
